        ...
        <form>
          <fieldset>
            ...
            <div className="timer-block">
              <img src={images.timer} className="timer-block_timer-img" alt={t(TRANSLATION.TIMER)}/>
              <article className="colored">
                {t(TRANSLATION.LEFT)} <span>{seconds}</span> {t(TRANSLATION.SECONDS)}
              </article>
