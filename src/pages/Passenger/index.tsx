...
const PassengerOrder: React.FC<IProps> = ({
  ...
  const [weight, setWeight] = useCachedState(
    ...
    undefined,
    SITE_CONSTANTS.PASSENGER_ORDER_CONFIG.values.weight.map((item) => item.id)
  );
  ...
  const openCurrentModal = () => {
    ...
    if (selectedOrder.b_voting && !selectedOrderDriver) {
      if (
        ...
        (selectedOrder.b_max_waiting || SITE_CONSTANTS.WAITING_INTERVAL) -
    ...
    if (
      ["96", "95"].some((item) => selectedOrder?.b_comments?.includes(item)) &&
      !selectedOrderDriver
    ) {
    ...
    if (
      [EBookingDriverState.Performer, EBookingDriverState.Arrived].includes(
    ...
    try {
      ...
      if ([TABS.DELIVERY.id, TABS.MOTORCYCLE.id, TABS.MOVE.id].includes(tab))
        options = {
          ...options,
          courier_auto:
            tab === TABS.DELIVERY.id ? courierAuto : TABS.MOTORCYCLE.id,
      ...
      await API.postDrive({
        ...
        b_car_class: [TABS.DELIVERY.id, TABS.MOVE.id, TABS.WAGON.id].includes(
          tab
        )
          ? ECarClasses.Any
          : carClass,
  ...
  const fromTimeFromOptions = getTimeOptions(
    moment(fromDay, dateFormatDate).days() === moment().days() ? moment() : null
  );
                  ...
                  <>
                    ...
                    <div className="move__elevator">
                      ...
                      {!_.sum(Object.values(elevator.steps)) && (
                        <div
                          className={cn("move__elevator-switcher-wrapper", {
                        ...
                        >
                          ...
                          <SwitchSlider
                            isVertical={
                              window.innerWidth < 768 && !elevator.elevator
                            }
                      ...
                      <hr
                        ...
                        style={{
                          backgroundColor: SITE_CONSTANTS.PALETTE.primary.dark,
                        }}
                      />
                    </div>
                    {/* <label
            ...
            />
                    ...
                    {room !== null && !!moveFiles[room]?.length && (
                      <Slider
                        ...
                        mobileFriendly
                        headerLabel={t(
                          (rooms.find((i) => i.id === room) as IRoom).label
                        )}
                      />
                    )}
                  </>
                  ...
                  <>
                    <Input
                      ...
                      options={[
                        ...
                        SITE_CONSTANTS.BIG_TRUCK_CARGO_TYPES.map((item) => ({
                          label: t(item.value),
                          value: item.value,
                        }))
                      )}
                      ...
                      <div className="big-truck__car-types">
                        <Input
                          ...
                          inputProps={{
                            ...
                            multiple:
                              values.bigTruckCarLogic !== ELogic.Nothing,
                            size: 1,
                          }}
                  ...
                  <>
                    ...
                    <GroupedInputs>
                      ...
                      <Input
                        ...
                        label={t(TRANSLATION.TIME_TILL)}
                        options={getTimeOptions(
                          toTimeFrom ? moment(toTimeFrom, dateFormatTime) : null
                        )}
                      />
                    </GroupedInputs>
                  </>
                ...
                {tab === TABS.DELIVERY.id && (
                  <>
                    <div
                      className="info"
                      style={{ color: SITE_CONSTANTS.PALETTE.primary.light }}
                    >
                  ...
                  <>
                    ...
                    <div className="info-block">
                      <div onClick={() => setPickTimeModal(true)}>
                        ...
                        <label
                          style={{ color: SITE_CONSTANTS.PALETTE.primary.dark }}
                        >
                          {typeof time === "string"
                            ? t(TRANSLATION.NOW)
